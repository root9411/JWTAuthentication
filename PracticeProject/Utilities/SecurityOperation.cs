...
namespace PracticeProject.Utilities
{
    public class SecurityOperation
    {
        ...
        /// salt password....
        /// </summary>
        private static byte[] _salt = Encoding.ASCII.GetBytes("42e5712c-8e0e-4ebb-a4e6-5569b44baeda");
        ...
        public static string EncryptStringAES(string textToEncrypt, string sharedSecret)
        {
        ...
        public static string DecryptStringAES(string textToDecrypt, string sharedSecret)
        {
